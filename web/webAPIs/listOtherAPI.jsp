...
<%@page language="java" import="model.userCatalog.StringData" %> 
<%@page language="java" import="model.userCatalog.StringDataList" %> 
...
<%
    ...
    if (list.dbError.length() == 0) { // if got good DB connection,
        ...
        System.out.println("*** Ready to call getAllBooks");
        list = UserCatalogView.getAllBooks(dbc);
